...
[![Tech Explorer](https://img.shields.io/badge/Tech_Explorer-Always%20Learning-blueviolet?style=for-the-badge&logo=gitbook&logoColor=white&labelColor=24283b)](https://github.com/developerrono)

---

| X (Twitter) | Portfolio | LinkedIn | Visitor Count |
|:---:|:---:|:---:|:---:|
| [![X Follow](https://img.shields.io/twitter/follow/iamrono?logo=twitter&style=flat-square&color=1DA1F2)](https://twitter.com/iamrono) | [![Portfolio](https://img.shields.io/badge/Visit-Portfolio-14b8a6?style=flat-square&logo=vercel)](https://ronoporfolio.vercel.app/) | [![LinkedIn](https://img.shields.io/badge/Connect-LinkedIn-blue?style=flat-square&logo=linkedin)](https://linkedin.com/in/developerrono) | ![Visitors](https://visitor-badge.laobi.icu/badge?page_id=developerrono.developerrono&left_text=Views&color=58a6ff&style=flat-square) |
...
|:--|:--|:--|
| 🧁 **LuckyDelights** | A vibrant minimalist bakery web app with ordering and admin dashboard. | React + Vite + Shadcn + Tailwind |
| 🏘 **Jamii Track** | Tenant & room management system for landlords and renters. | MERN Stack + JWT + Tailwind |
| 💳 **TinyLabs Solutions** | Wi-Fi billing system integrated with M-Pesa API. | TypeScript + MySQL + Node.js + Express |
...
![VS Code](https://img.shields.io/badge/Editor-VS_Code-0078D4?style=flat-square&logo=visual-studio-code&logoColor=white)
...
[![Portfolio](https://img.shields.io/badge/Visit-Portfolio-14b8a6?style=for-the-badge&logo=vercel)](https://ronoporfolio.vercel.app/)
